...
func NewAction(id, method, path, description string, inputSchema, outputSchema, parameters map[string]interface{}, hasResponseOwnership bool) Action {
	return Action{
		ID:                   id,
		Method:               method,
		Path:                 path,
...
func NewActionFromObject(id string, rawData interface{}) (Action, error) {
	...
	return NewAction(id, method, path, description, inputSchema, outputSchema, parameters, hasResponseOwnership), nil
}
